...
const Footer = () => {
    return (
        <footer className="footer">
            <section className="bg-primary text-light py-4 py-md-5 py-xl-8 border-top border-light">
                        ...
                        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                            <div className="widget">
                                ...
                                <ul className="list-unstyled">
                                    <li className="mb-2">
                                        <a href="#!" className="link-light text-decoration-none">About</a>
                                    </li>
                                    <li className="mb-2">
                                        <a href="#!" className="link-light text-decoration-none">Contact</a>
                                    </li>
                                    <li className="mb-2">
                                        <a href="#!" className="link-light text-decoration-none">Advertise</a>
                                    </li>
                                    <li className="mb-2">
                                        <a href="#!" className="link-light text-decoration-none">Terms of Service</a>
                                    </li>
                                    <li className="mb-0">
                                        <a href="#!" className="link-light text-decoration-none">Privacy Policy</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="row gy-4 gy-md-0">
                        <div className="col-xs-12 col-md-7 order-1 order-md-0">
                            ...
                            <div className="credits text-secondary text-center text-md-start mt-2 fs-7">
                                Built by <a href="https://bootstrapbrain.com/" className="link-light text-decoration-none">BootstrapBrain</a> with <span className="text-primary">&#9829;</span>
                            </div>
                        </div>
