                        ...
                        <div className="card-body p-3 p-md-4 p-xl-5">
                            <div className="row">
                                <div className="col-12">
                                    <div className={"alert alert-warning alert-dismissible fade " + (notLoggedIn == true? "show":"hide")} role="alert">
                                        {msg}
                                        <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close" onClick={() => setLoggedInFlag(false)}></button>
                                    </div>
                                    <div className="mb-2">
                                        ...
                                        <h3 className="fs-6 fw-normal text-secondary text-center m-0">Enter your details to sign in</h3>
                                    </div>
                                </div>
                            </div>
                            <form action="#!">
                                <div className="row gy-3 overflow-hidden">
                                    ...
                                    <div className="col-12">
                                        <div className="form-floating mb-3">
                                            <input type="password" className="form-control" name="password" id="password" defaultValue={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" required />
                                            <label htmlFor="password" className="form-label">Password</label>
                                        </div>
                                    </div>
                                    <div className="col-12">
                                        <div className="d-grid">
                                            <button className="btn bsb-btn-xl btn-primary" type="submit" onClick={Signin}>Sign in</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <p className="m-0 text-secondary text-center">Create New Account?
